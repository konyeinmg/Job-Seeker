...
<head>
  ...
  <link rel="stylesheet" href="css/devcustom-bs.css">
  <link rel="stylesheet" href="css/devbootstrap-select.min.css">
  <link rel="stylesheet" href="css/devanimate.min.css">
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-9">
            ...
            <form method="post" class="search-jobs-form" action="searchworker">
              @csrf
              <div class="row mb-5">
                
        
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0" style="margin-left:20px">
                  <select class="selectpicker" data-style="btn-white btn-lg" data-width="100%" title="Select Filter" name="filter">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0" style="margin-left:20px">
                  <input type="text" class="form-control form-control-lg" placeholder="Search" value="{{Session::get('searching')}}" name="search">
                </div>
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0" style="margin-left:20px">
      ...
      <div class="container">
          <div class="span12">
            <div class="row1">
              ...
              <div class="span3" style="box-shadow:1.5px 1.5px 10px 1.5px #888D9D;padding:20px 0px 20px 0px;background-color:white;">
                <div class="box aligncenter">
                  <div class="aligncenter icon">
					         <img src="{{$data->photopath}}" style="border-radius:50px;width:80px;height:80px">
                  </div><br>
                  <div class="text">
                    <h5 style="color:#026BE8">{{$data->name}}</h5>
                    <p>
					           <i style="font-weight:bold">{{$data->role}}</i><br><br>
                     ...
                     ?>
                      ...
                      @if($value != 0)
                      <span style="color:black; background-color:  #cecfda  ; border-radius: 10px">{{$key}}</span>
                      @endif
                      @endforeach
                      @endif
                    </p>
                    @if(Session::get('auth') != "yes")
                    <a href="viewlogin">Learn more</a><br>
                    @else
                    <a href="viewcvformother/{{$data->email}}">Learn more</a><br>
                    @endif
                  </div>
                </div>
              </div>
              @endforeach
             <!-- <div class="span3" style="box-shadow:3px 3px 10px 3px #888D9D;padding:20px 0px 20px 0px;background-color:#DDE1E7;">
                <div class="box aligncenter">
                  <div class="aligncenter icon">
                    <img src="img/a.jpg" style="border-radius:50px;width:80px;height:80px">
                  </div>
                  <div class="text">
                    <h5 style="color:#026BE8">Nyein Mg</h5>
                    <p>
					  <i style="font-weight:bold">Programmer</i><br><br>
                       Skill->Lorem ipsum dolor<br> sit amet, has ei ipsum scaevola deseruisse am sea facilisis.
                    </p>
              ...
              <div class="span3"style="box-shadow:3px 3px 10px 3px #888D9D;padding:20px 0px 20px 0px;background-color:#DDE1E7;" >
                <div class="box aligncenter">
                  <div class="aligncenter icon">
                      <img src="img/c.jpg" style="border-radius:50px;width:80px;height:80px">
                  </div>
                  <div class="text">
                    <h5 style="color:#026BE8">Myo Wai Aung</h5>
                    <p>
					   <i style="font-weight:bold">Manager</i><br><br>
                      Skill->Lorem ipsum dolor<br> sit amet, has ei ipsum scaevola deseruisse am sea facilisis.
                    </p>
                    <a href="#">Learn more</a><br>
                  </div>
              ...
              <div class="span3" style="box-shadow:3px 3px 10px 3px #888D9D;padding:20px 0px 20px 0px;background-color:#DDE1E7;">
                <div class="box aligncenter">
                  <div class="aligncenter icon">
                      <img src="img/d.jpg" style="border-radius:50px;width:80px;height:80px">
                  </div>
                  <div class="text">
                    <h5 style="color:#026BE8">Yan Naing Aung</h5>
                    <p>
					<i style="font-weight:bold">Dabase Manager</i><br><br>
                       Skill->Lorem ipsum dolor<br> sit amet, has ei ipsum scaevola deseruisse am sea facilisis.
                    </p>
                    <a href="#">Learn more</a><br>
                  </div>
...
<script src="lib/jquery/jquery.min.js"></script>
  ...
  <script src="js/devcustom.js"></script>
