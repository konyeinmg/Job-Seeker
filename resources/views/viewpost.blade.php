  ...
  <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-9">
            ...
            <form method="post" class="search-jobs-form" action="/searchengine">
              @csrf
              <div class="row mb-5">
                
        
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0" style="margin-left:20px">
                  <select class="selectpicker" data-style="btn-white btn-lg" data-width="100%" title="Select Filter" name="filter" value="{{Session::get('filter')}}" required/>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0" style="margin-left:20px">
                  <input type="text" class="form-control form-control-lg" placeholder="Search" name="search" value="{{Session::get('searching')}}" required/>
                </div>
                ...
                <div class="col-md-12" alignment="center">
                  ...
                  <div class="blog-entry ftco-animate d-md-flex">
                    ...
                    <div class="text text-2 pl-md-4">
                      ...
                      <div class="meta-wrap">
                        <p class="meta">
                          <?php  
                            ...
                            $deadline = date("M,d,Y");
                           ?>
                          <span><i class="icon-calendar mr-2"></i>{{$d->date}}</span>
                      ...
                      @if($bool == 1)
                      <p><a type="button" style="float:left;border-radius:500px;"><button type="submit" class="btn-primary text-white" style="color: black;" disabled>Joined</button></a></p>
                      @else
                       <p><a href="postjoin/{{$d->id}}" style="float:left;border-radius:500px;"><button type="submit" class="btn-primary text-white icon-join mr-2" style="padding: 8px;"> Join</button></a></p>
                       @endif
                       <?php $bool = 0; ?>
                       @else
                       <p><a href="postjoin/{{$d->id}}" style="float:left;border-radius:500px;"><button type="submit" class="btn-primary text-white icon-join mr-2" style="padding: 8px;"> Join</button></a></p>
